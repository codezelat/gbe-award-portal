...
Both nomination lists use desktop tables and readable cards on phones and tablets. In-progress keeps the saved step, last update and nomination visible, with full details one click away. Search updates after a short typing pause; Clear resets it, and pagination keeps the active search. Deletion always requires confirmation.
