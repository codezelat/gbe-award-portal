...
- **Sensitive operations** write audit events. A super admin may permanently remove only an empty, unfinished nomination shell; the operation refuses submitted nominations or retained evidence and removes its staged private uploads and linked operational records. Administrative data is noindexed, and platform headers block framing and apply a restrictive content policy.
