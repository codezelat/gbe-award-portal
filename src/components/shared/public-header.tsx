    ...
    <header className="glass-shell sticky top-0 z-40">
      <div className="mx-auto flex h-20 max-w-7xl items-center justify-between px-5 md:px-10">
        ...
        >
          ...
          <Link
            href="/login"
            className="flex min-h-11 items-center gap-2 rounded-md border border-mist bg-white/70 px-4 text-sm font-medium transition-colors hover:border-champagne"
          >
